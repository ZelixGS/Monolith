class_name Slant extends AnimationComponent
## [b]Skew[/b] is a basic animation that can be attached to Sprite2D, Sprite3D or any derivative.
## When attached and configured the sprite will be slanted illusion of rotation on a Z axis.
